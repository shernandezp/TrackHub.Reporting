...
using TrackHub.Reporting.Web.Endpoints;
...
public sealed class ContainerValidationTests
{
    ...
    private sealed class ReportingFactory : WebApplicationFactory<BasicReports>
    {
        protected override IHost CreateHost(IHostBuilder builder)
        {
            ...
            // service — here that would share one report request's scope with the next.
